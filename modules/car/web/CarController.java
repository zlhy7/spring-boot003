package com.renyong.springboot003.modules.car.web;

import com.github.pagehelper.PageInfo;
import com.renyong.springboot003.base.util.GenerateUtil;
import com.renyong.springboot003.base.util.StringUtil;
import com.renyong.springboot003.base.web.BaseController;
import com.renyong.springboot003.modules.car.model.Car;
import com.renyong.springboot003.modules.car.service.CarService;
...
public class CarController extends BaseController<CarService> {
    ...
    public String list(Car car,Model model){
        //修改一条记录
//        car.setId("e129e53bc58311e9be8a98eecb60554b");
//        car.setCarBrand("修改品牌");
//        service.update(car);
